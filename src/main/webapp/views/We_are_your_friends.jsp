...
<main class="main">
    <div class="main_inner">
        <div class="main_inner_title_content">
            <img src="img/MoviePoster/We_are_your_friends/we-are-your-friends-3.jpg" class="main_inner_title_photo" alt="season's greetings" srcset="">
            <h1 class="main_inner_title">We are your friends</h1>
        ...
        <div class="main_inner_main_content">
            ...
            <div class="main_text">
                ...
                <p >
                    Writers: <br>
                    <a href="https://www.imdb.com" class="test_description_movie"  target="_blank">Max Joseph</a> (screenplay),
                </p>
                ...
                <p >
                    Schedule: <br>
                    <a  class="test_description_movie"  target="_blank"> 00:30 and 03:30 every Thursday</a>
                        ...
                        Available time and day and number of seat &nbsp
                            ...
                            <%
                                ...
                                ArrayList infoForTimeTable = new ArrayList();
                                 infoForTimeTable = db_managerDAO.findAllMovieSessionByName("We are your friends");
