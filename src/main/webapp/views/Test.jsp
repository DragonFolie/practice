...
<main class="main">
    <div class="main_inner">
        <div class="main_inner_title_content">
            <img src="img/MoviePoster/null/test" class="main_inner_title_photo" alt="season's greetings" srcset="">
        ...
        <div class="main_inner_main_content">
            ...
            <div class="main_text">
                ...
                <p >
                    Schedule: <br>
                    <a  class="test_description_movie"  target="_blank"> 06:36 and 08:39 every Tuesday</a>
