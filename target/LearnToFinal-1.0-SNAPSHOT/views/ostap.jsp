...
<main class="main">
    <div class="main_inner">
        <div class="main_inner_title_content">
            <img src="img/MoviePoster/ostap/ostap" class="main_inner_title_photo" alt="season's greetings" srcset="">
            <h1 class="main_inner_title">ostap</h1>
        ...
        <div class="main_inner_main_content">
            ...
            <div class="main_text">
                ...
                <p >
                    Headliner: <br>
                    <a href="https://www.imdb.com" class="test_description_movie"   target="_blank" > ostap </a>
                ...
                <p >
                    Speaker: <br>
                    <a href="https://www.imdb.com" class="test_description_movie"  target="_blank">ostap</a> (screenplay),
                </p>
                ...
                <p >
                    Schedule: <br>
                    <a  class="test_description_movie"  target="_blank"> 01:59 and 04:02 every Wednesday</a>
