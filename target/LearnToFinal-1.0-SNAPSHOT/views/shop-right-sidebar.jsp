            ...
            <div class="row">
                ...
                <div class="col-md-4 col-sm-5">
                    <div class="header-top-right">
                        <ul>
                            <li>
                                <a href=" log_reg/register.jsp"><i class="flaticon-user"></i>Register</a>
                                <span>or</span>
                                <a href=" log_reg/login.jsp">Sign in</a>
                            </li>
                        </ul>
                    </div>
                </div>
                    ...
                    <div class="menu-wrap">
                        <nav class="menu-nav show">
                            ...
                            <div class="navbar-wrap main-menu d-none d-lg-flex">
                                <ul class="navigation">
                                    <li ><a href="movies.jsp">MOVIE</a></li>

                                    <li ><a href="" target="_blank">CONTACTS</a></li>

                                    <li class="dropdown active"><a >SHOP</a></li>
                    ...
                    <div class="row">
                        <div class="col-xl-4 col-lg-6 col-md-4 col-sm-6">
                            <div class="exclusive-item exclusive-item-three text-center mb-50">
                                ...
                                <div class="exclusive-item-content">
                                    <h5><a href=" shop-details.jsp">Short Sleev T-Shirt</a></h5>
                        ...
                        <div class="col-xl-4 col-lg-6 col-md-4 col-sm-6">
                            <div class="exclusive-item exclusive-item-three text-center mb-50">
                                ...
                                <div class="exclusive-item-content">
                                    <h5><a href=" shop-details.jsp">WOMAN Short Sleev T-Shirt</a></h5>
                                    <div class="exclusive--item--price">
                                        <del class="old-price">$15.00</del>
                                        <span class="new-price">$10.99</span>
                                    </div>
                        ...
                        <div class="col-xl-4 col-lg-6 col-md-4 col-sm-6">
                            <div class="exclusive-item exclusive-item-three text-center mb-50">
                                ...
                                <div class="exclusive-item-content">
                                    <h5><a href=" shop-details.jsp">Long Sleev T-Shirt</a></h5>
                                    <div class="exclusive--item--price">
                                        <del class="old-price">$15.00</del>
                                        <span class="new-price">$10.99</span>
                                    </div>
                        ...
                        <div class="col-xl-4 col-lg-6 col-md-4 col-sm-6">
                            <div class="exclusive-item exclusive-item-three text-center mb-50">
                                ...
                                <div class="exclusive-item-content">
                                    <h5><a href=" shop-details.jsp">HINTERLAND Theme AXE</a></h5>
                                    <div class="exclusive--item--price">
                        ...
                        <div class="col-xl-4 col-lg-6 col-md-4 col-sm-6">
                            <div class="exclusive-item exclusive-item-three text-center mb-50">
                                ...
                                <div class="exclusive-item-content">
                                    <h5><a href=" shop-details.jsp">The Long Dark Theme Cup</a></h5>
                                    <div class="exclusive--item--price">
