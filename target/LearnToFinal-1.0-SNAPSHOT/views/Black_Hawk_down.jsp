...
<main class="main">
    <div class="main_inner">
        <div class="main_inner_title_content">
            <img src="img/MoviePoster/Black_Hawk_down/black_hawk.jpg" class="main_inner_title_photo" alt="season's greetings" srcset="">
            <h1 class="main_inner_title">Black Hawk down</h1>
        ...
        <div class="main_inner_main_content">
            ...
            <div class="main_text">
                ...
                <p >
                    Director: <br>
                    <a href="https://www.imdb.com" class="test_description_movie"   target="_blank" > Max Verstapen </a>
                ...
                <p >
                    ...
                    <a href="https://www.imdb.com" class="test_description_movie"  target="_blank"> Niki Lauda ,</a>
                ...
                <p >
                    Schedule: <br>
                    <a  class="test_description_movie"  target="_blank"> 05:10 and 08:10 every Tuesday</a>
                        ...
                        Available time and day and number of seat &nbsp
                            ...
                            <%
                                ...
                                ArrayList infoForTimeTable = new ArrayList();
                                 infoForTimeTable = db_managerDAO.findAllMovieSessionByName("Black Hawk down");
...
<footer class="footer">
    ...
    <div class="footer_inner">
        ...
        <ul class="footer_list_text">
            <li >
                <a href="moviesUa.jsp" class="footer_list_text_li">EVENTS</a>
            </li>
